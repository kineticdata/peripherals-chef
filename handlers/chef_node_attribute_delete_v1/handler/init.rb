...
class ChefNodeAttributeDeleteV1
  ...
  def execute
    ...
    # If no error, rebuild the node object with the deleted attribute and PUT it to the Chef server
    ...
    # Delete the attribute from the node
    node_attributes.delete(@parameters['attribute_name'])
